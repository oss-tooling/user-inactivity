...
const preserveAccountComment = (user) => {
  if (process.env.ISSUE_WITHOUT_MENTION.toLowerCase() === 'true') {
    return `Thank you, I will mark your account active.  Please remember this 90 day audit will be part of the continuous monitoring for GitHub, so please maintain activity of one of the following to avoid be pulled as inactive again.
1. Commits
2. Created issue(s)
3. Created PR(s)
